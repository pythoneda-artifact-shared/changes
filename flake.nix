  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        pythoneda-artifact-shared-changes-0_0_1a1-for =
      ...
      in rec {
        packages = rec {
          pythoneda-artifact-shared-changes-0_0_1a1-python38 =
            pythoneda-artifact-shared-changes-0_0_1a1-for {
              pythoneda-base =
                pythoneda-base.packages.${system}.pythoneda-base-latest-python38;
              python = pkgs.python38;
            };
          pythoneda-artifact-shared-changes-0_0_1a1-python39 =
            pythoneda-artifact-shared-changes-0_0_1a1-for {
              pythoneda-base =
                pythoneda-base.packages.${system}.pythoneda-base-latest-python39;
              python = pkgs.python39;
            };
          pythoneda-artifact-shared-changes-0_0_1a1-python310 =
            pythoneda-artifact-shared-changes-0_0_1a1-for {
              pythoneda-base =
        ...
        devShells = rec {
          pythoneda-artifact-shared-changes-0_0_1a1-python38 =
            shared.devShell-for {
              package =
                packages.pythoneda-artifact-shared-changes-0_0_1a1-python38;
              pythoneda-base =
                pythoneda-base.packages.${system}.pythoneda-base-latest-python38;
              python = pkgs.python38;
          ...
          pythoneda-artifact-shared-changes-0_0_1a1-python39 =
            shared.devShell-for {
              package =
                packages.pythoneda-artifact-shared-changes-0_0_1a1-python39;
              pythoneda-base =
                pythoneda-base.packages.${system}.pythoneda-base-latest-python39;
              python = pkgs.python39;
              inherit pkgs nixpkgsRelease;
          ...
          pythoneda-artifact-shared-changes-0_0_1a1-python310 =
            shared.devShell-for {
              package =
                packages.pythoneda-artifact-shared-changes-0_0_1a1-python310;
              pythoneda-base =
                pythoneda-base.packages.${system}.pythoneda-base-latest-python310;
              python = pkgs.python310;
              inherit pkgs nixpkgsRelease;
