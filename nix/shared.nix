rec {
  shellHook-for = { package, pythoneda-base, python, nixpkgsRelease }: ''
    ...
    echo -e " \033[32m| '_ \| | | | __| '_ \ / _ \| '_ \ \033[34m/ _ \\\\\033[35m/ _\` |\033[36m/ _\` |\033[33mhttps://github.com/pythoneda-artifact-shared/changes/tree/$PVERSION\033[0m";
    ...
    echo -e " \033[32m|_| \033[31mS\033[36mA\033[32m |___/                \033[33mCHANGES\033[0m";
    echo;
    echo " Thank you for using pythoneda-artifact-shared/changes, PythonEDA in general, and for your appreciation of free software.";
    echo;
